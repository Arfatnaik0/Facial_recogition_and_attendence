...
window = Tk()
window.title("ECHO: Face Recognition and attendance")
...
logo = logo.resize((45, 45), Image.LANCZOS)
...
titl = tk.Label(
    window, text="Project Echo", bg="#1c1c1c", fg="White", font=("Verdana", 25, "bold"),
)
...
credit1 = tk.Label(
    window,
    text=
    "Project Echo Group-12\n",
    bg="#1c1c1c",  # Dark background for the main text
    fg="grey",
    bd=10,
    font=("Verdana", 22, "bold"),
)
credit1.place(x=735,y=375)
...
credit2.place(x=735,y=420)

ri = Image.open("UI_Image/reg.jpg")
ri = ri.resize((120,120))
r = ImageTk.PhotoImage(ri)
label1 = Label(window, image=r)
label1.image = r
label1.place(x=60, y=200)

ai = Image.open("UI_Image/atten.jpg")
ai = ai.resize((120,120))
a = ImageTk.PhotoImage(ai)
label2 = Label(window, image=a)
label2.image = a
label2.place(x=60, y=375)

vi = Image.open("UI_Image/check.jpg")
vi = vi.resize((120,120))
v = ImageTk.PhotoImage(vi)
label3 = Label(window, image=v)
label3.image = v
label3.place(x=60, y=550)
...
def TakeImageUI():
    ...
    # image and title
    titl = tk.Label(
        ImageUI, text="Register Your Face", bg="#1c1c1c", fg="green", font=("Verdana", 26, "bold"),
    )
